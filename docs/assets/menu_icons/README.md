...
The four supplied SVG files are mapped to the main menu as follows:
...
- `est_menu_icons_32x32.h` declares the four arrays.
- `est_menu_icons_32x32.c` contains the packed bitmap data.
